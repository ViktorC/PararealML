...
from src.core.integrator import ForwardEulerMethod, ExplicitMidpointMethod, \
    RK4, BackwardEulerMethod, CrankNicolsonMethod
...
def test_crank_nicolson_method():
    ...
    actual_y_next = crank_nicolson.integral(y_0, t_0, d_t, d_y_over_d_t)
...
def test_crank_nicolson_method_with_constraints():
    ...
    actual_y_next = crank_nicolson.integral(
        y_0, t_0, d_t, d_y_over_d_t, [y_constraint])
...
def test_crank_nicolson_method_with_a_eq_0_matches_forward_euler():
    ...
    cn_integral = crank_nicolson.integral(y_0, t_0, d_t, d_y_over_d_t)
    fe_integral = forward_euler.integral(y_0, t_0, d_t, d_y_over_d_t)
...
def test_crank_nicolson_method_with_a_eq_1_matches_backward_euler():
    ...
    cn_integral = crank_nicolson.integral(y_0, t_0, d_t, d_y_over_d_t)
    be_integral = backward_euler.integral(y_0, t_0, d_t, d_y_over_d_t)
