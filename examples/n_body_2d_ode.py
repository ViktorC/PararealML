...
velocities = [
    0.0,
    0.0,
    -v_x / v_length * orbital_v_moon,
    v_y / v_length * orbital_v_moon,
    -v_y / v_length * orbital_v_moon,
    -v_x / v_length * orbital_v_moon,
    v_x / v_length * orbital_v_moon,
    -v_y / v_length * orbital_v_moon,
...
ic = ContinuousInitialCondition(cp, lambda _: np.array(positions + velocities))
ivp = InitialValueProblem(cp, (0.0, 120 * day), ic)
